                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <th scope="col" class="border-0 bg-light">
                                    <div class="align-middle text-center">Customize</div>
                                </th>
                                <th scope="col" class="border-0 bg-light">
                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/kfc-kiosk/img/food-'.$foodId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$foodName. '</h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$foodPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
                                                <td class="align-middle text-center"><strong>' .$customize1. '</strong></td>
