      ...
      <div class="modal-body">
		...
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2">
                ...
                <input class="form-control" id="opt1" name="opt1" value="<?php echo $foodopt1; ?>" type="text" default="none" required>
            </div>
			<div class="text-left my-2">
                <b><label for="opt2">Customize option 2</label></b>
                <input class="form-control" id="opt2" name="opt2" value="<?php echo $foodopt2; ?>" type="text" default="none" required>
            </div>
            <div class="text-left my-2">
